...
export const ACTION_SET_CHECKED_ARRIVE_STATINS =
  "ACTION_SET_CHECKED_ARRIVE_STATINS";
...
export function setCheckedArriveStatins(checkedArriveStatins) {
  return {
    type: ACTION_SET_CHECKED_ARRIVE_STATINS,
    payload: checkedArriveStatins
  };
}
